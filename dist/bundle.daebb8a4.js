...
(function webpackUniversalModuleDefinition(root, factory) {
    if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["Vector"] = factory();else root["Vector"] = factory();
})(this, function () {
    return (/******/function (modules) {
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            var DinamicBody = function () {
                function DinamicBody(position, restitution) {
                    if (position === void 0) {
                        position = new Vector2D_1["default"](0, 0);
                    }
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            function average(vectorList) {
                var vec = vectorList.reduce(function (a, c) {
                    return add(a, c);
                }, [0, 0]);
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            var Graphic = function () {
                function Graphic(renderFunction, position, scale, rotation) {
                    if (position === void 0) {
                        position = new Vector2D_1["default"](1, 1);
                    }
                    if (scale === void 0) {
                        scale = new Vector2D_1["default"](1, 1);
                    }
                    if (rotation === void 0) {
                        rotation = 0;
                    }
            ...
            var World = function () {
                ...
                World.prototype.update = function () {
                    ...
                    this.particles.forEach(function (particle) {
                        ...
                        if (_this.gravity) {
                            if (particle.addForce) particle.addForce(_this.gravity);
                        }
                        if (_this.boundsSet) _this.insideBounds(particle);
                        // }
                    });
                };
                ...
                World.prototype.check = function (particle) {
                    for (var i = 0; i < this.particles.length; i++) {
                        if (particle.id !== this.particles[i].id) {
                            if (particle.position.x < this.particles[i].position.x + this.particles[i].size.x && particle.position.x + particle.size.x > this.particles[i].position.x && particle.position.y < this.particles[i].position.y + this.particles[i].size.y && particle.size.y + particle.position.y > this.particles[i].position.y) {
                                /*
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            var Collider = function (_super) {
                ...
                Collider.prototype.collides = function (other) {
                    if (this.position.x < other.position.x + other.size.x && this.position.x + this.size.x > other.position.x && this.position.y < other.position.y + other.size.y && this.size.y + this.position.y > other.position.y) {
                        return true;
                    } else {
                        return false;
                    }
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            var Sprite = function () {
                function Sprite(src, position, scale, rotation, anchor) {
                    ...
                    if (anchor === void 0) {
                        anchor = new Vector2D_1["default"](0.5, 0.5);
                    }
                    this.load(src);
                    this.position = position;
                    this.scale = scale;
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            var Animation = function () {
                function Animation(src, scale, position, frameRate, size, loop) {
                    ...
                    if (size === void 0) {
                        size = new Vector2D_1["default"](32, 32);
                    }
                    if (loop === void 0) {
                        loop = true;
                    }
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            var StaticRect = function () {
                function StaticRect(position, size) {
                    ...
                    if (size === void 0) {
                        size = new Vector2D_1["default"](5, 5);
                    }
                    this.position = position;
                    this.size = size;
                    this.type = 'rect';
                ...
                if (type === 'Circle') {
                    ...
                    if (type === 'Mesh') {
                        config.vertices.forEach(function (vertex) {
                            return _this.vertices.add(vertex);
                        });
                    } else if (type === 'Box') {
            ...
            var Figure = function () {
                ...
                Figure.prototype.translate = function (vec) {
                    this.points = this.points.map(function (x) {
                        return vectorFunctions_1["default"].add(x, vec);
                    });
                };
                Figure.prototype.rotate = function (rotation) {
                    var _this = this;
                    this.points = this.points.map(function (x) {
                        return vectorFunctions_1["default"].setAngle(x, _this.rotation + rotation);
                    });
                };
                Figure.prototype.scale = function (vec) {
                    this.points = this.points.map(function (x) {
                        return vectorFunctions_1["default"].mult(x, vec);
                    });
                };
                ...
                Figure.prototype.far = function (center) {
                    return vectorFunctions_1["default"].mag(this.points.reduce(function (a, c) {
                        if (vectorFunctions_1["default"].distance(a, center) > vectorFunctions_1["default"].distance(c, center)) return a;else return c;
                    }));
                };
                return Figure;
            }();
        ...
        /***/function (module, exports, __webpack_require__) {
            ...
            function meshCircleIntersect(mesh, circle) {
                mesh.vertices.points.forEach(function (vertex) {
                    if (vectorFunctions_1["default"].distance(vertex, circle.center) < circle.far) collision(mesh, circle);
                });
            }
                        ...
                        _this.bodies.forEach(function (body2, index2) {
                            if (index !== index2) {
                                if (vectorFunctions_1["default"].distance(body.center, body2.center) < body.far + body2.far) {
                                    if (body.type !== 'Circle' && body2.type !== 'Circle') meshIntersect(body, body2);else if (body.type !== 'Circle' && body2.type === 'Circle') meshCircleIntersect(body, body2);else if (body.type === 'Circle' && body2.type !== 'Circle') meshCircleIntersect(body2, body);else circleIntersect(body, body2);
                                }
                            }
                        });
                    });
...
//# sourceMappingURL=/bundle.daebb8a4.map